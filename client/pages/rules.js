  ...
  return (
    <Layout>
      <div className="rulesBody">
        ...
        <p>※なお、本サイトはVercelの無料プランを利用しており、無料プランのCron Jobs（テストの締め切りが過ぎたどうか＆ペナルティ期間が過ぎたどうかなどを自動的に判断するもの）は<strong>一時間以内の遅延が生じる</strong>ことがあります。例えば、締め切りが4月16日0時のテストは、4月16日0時50分でやっと締め切りになることがあります。そこらへんは悪しからず……<br/><br/>予言テストの流れは以上です。<br/>不明点がありましたら、<Link href={`/contact`}>こちら</Link>までご連絡ください。
        </p>
      </div>
