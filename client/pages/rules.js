    ...
    <Layout>
      <div className="rulesBody">
        ...
        <section className="checkOutCorner">
          ...
          <p><small>※選択肢をクリックすると、このように該当選択肢の内容が「説明」のところに出てきます。<br/>2023/4/27追記：諸問題により、説明文を修正するとエラーが出たり、説明文が反映されなかったりすることがあります。今は修正に取り組んでおりますが、正直に言いますと直せるかどうかまだわからないのです……本当に申し訳ございませんOTZ</small></p>
          <p>3.完成！
